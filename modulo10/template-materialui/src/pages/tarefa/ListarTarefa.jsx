...
const initialRows = [
  createData(1, 'Tarefa 1', 'Manipulação de Template por ReactJS', '2022-09-28', '2024-12-08', 'Aguardando', 'Prática Integradora Tecnologias Disruptivas'),
  createData(2, 'Tarefa 2', 'Manipulação de Template por Android Studio', '2022-05-14', '2024-04-20', 'Concluída', 'Prática Integradora Desenvolvimento de Apps'),
  createData(3, 'Tarefa 3', 'Manipulação de Template por Python', '2022-09-28', '2024-06-08', 'Concluída', 'Prática Integradora Desenvolvimento de Software'),
  createData(4, 'Tarefa 4', 'Manipulação de Template por CLion', '2022-09-28', '2024-10-02', 'Concluída', 'Criação de Aplicações e Sistemas'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardActions>
            <Button size="small" variant="success" onClick={handleOpen}>Criar Tarefa</Button>
